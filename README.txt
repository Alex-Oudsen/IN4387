...
Running it will run all tests on all versions of the model and show show the model, the test name and the result
(true or false). The output can be compared with the table provided in the report.
